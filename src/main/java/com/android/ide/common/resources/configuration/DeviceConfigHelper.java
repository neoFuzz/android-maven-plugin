...
public class DeviceConfigHelper {
     ...
     *
     * @param state The {@link State} of the {@link Device} to base the
     ...
     *
     * @param d         The {@link Device} to base the {@link FolderConfiguration} on.
     * @param stateName The name of the state to base the {@link FolderConfiguration}
     *                  on.
     ...
     *
     * @param d The {@link Device} to generate the {@link FolderConfiguration}
     *          from.
