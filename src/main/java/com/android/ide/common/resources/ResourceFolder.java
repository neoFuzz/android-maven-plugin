...
public final class ResourceFolder implements Configurable {
     ...
     *
     * @return the {@link IAbstractFolder} associated with this object.
     */
     ...
     *
     * @return the {@link ResourceFolderType} of this object.
     */
    ...
    /**
     * @return the {@link ResourceRepository} associated with this folder.
     */
    ...
    /**
     * @return the list of {@link ResourceType}s generated by the files inside this folder.
     */
    @NonNull
     ...
     * @return <code>true</code> if the folder contains a file with the given name.
     */
     ...
     * @return true if the folder is generating a resource of the given type.
     */
