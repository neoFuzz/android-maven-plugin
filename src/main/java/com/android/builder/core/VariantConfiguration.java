 ...
 * - an optional list of product flavors (base interface ProductFlavor) and their associated sources.
...
public class VariantConfiguration<T extends BuildType, D extends ProductFlavor, F extends ProductFlavor> {
    ...
    /**
     * Fills a list with the Object from a given list of ClassField only if the name isn't in a set.
     * Each new item added will add its name to the list.
     *
     ...
     * package.
     *
     * @param output the output of the library as an LibraryDependency that will provide the
    ...
    public List<AssetSet> getAssetSets(@NonNull List<File> generatedResFolders,
        ...
        // multi flavor specific overrides flavor
        if (mMultiFlavorSourceProvider != null) {
