...
public class SimpleTestCallable implements Callable<Boolean> {
    ...
    /**
     * The name of the ec file that will be generated by the test.
     */
     ...
     * @param testedApks  The tested APKs
     * @param testData    The test data
     * @param resultsDir  The directory where to put the results
     * @param coverageDir The directory where to put the coverage data
