...
import static com.android.builder.signing.SignedJarBuilder.digestManifest;

/**
 * A Jar file builder with signature support.
 * <p>
 * Android-Builder is in the Gradle package, there is no replacement
 * </p>
 *
 * @deprecated Use Android-Builder instead
 */
@Deprecated(since = "26.1.0") // Google's deprecated version
public class SignedJarBuilder {
        ...
        try (ZipInputStream zis = new ZipInputStream(input)) {
            ...
            while ((entry = zis.getNextEntry()) != null) {
                ...
                if (!entry.isDirectory() && !name.startsWith("META-INF/") &&
                        ...
                        (filter == null || filter.checkEntry(name))) {
                    JarEntry newEntry;
    ...
    public interface IZipEntryFilter {
         ...
         */
        @SuppressWarnings("unused") // should be used by external libraries at runtime
