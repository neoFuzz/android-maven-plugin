...
final class ResourceClassGenerator {
    ...
    /**
     * Generates R java files whose libraries do not already have their R java in the {@code compile} classpath.
     * <p>
    ...
    public void generateLibraryRs(@NonNull final Set<Artifact> libraries) throws IOException {
        ...
        for (final Artifact lib : libraries) {
            ...
            if (rFile.isFile()) {
                ...
                final String packageName = new DefaultManifestParser().getPackage(libManifestFile);
